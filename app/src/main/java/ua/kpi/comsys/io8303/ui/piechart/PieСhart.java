package ua.kpi.comsys.io8303.ui.piechart;
...
public class PieСhart extends Fragment {
    ...
    private void showPieChart(PieChart pieChart){
        ...
        typeAmountMap.put("1",45);
        typeAmountMap.put("2",5);
        typeAmountMap.put("3",25);
        typeAmountMap.put("4",25);


        //initializing colors for the entries
        ArrayList<Integer> colors = new ArrayList<>();
        colors.add(Color.parseColor("#74CEE8"));
        colors.add(Color.parseColor("#D974E8"));
        colors.add(Color.parseColor("#EBED60"));
        colors.add(Color.parseColor("#A4A49B"));
        ...
        pieData.setDrawValues(true); //remove values
